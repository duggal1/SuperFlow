...
const AccessibilityPermissions: React.FC = () => {
  ...
  const buttonConfig: Record<PermissionState, ButtonConfig | null> = {
    request: {
      ...
      className:
        "px-2 py-1 text-sm font-semibold bg-stone-900 border  border-stone-700 hover:bg-surface-hover rounded cursor-pointer hover:border-stone-600",
    },
    verify: {
      text: t("accessibility.openSettings"),
      className:
  ...
  return (
    <div className="p-4 w-full rounded-[10px] bg-surface">
