...
// Collapse a language tag to the base code SuperFlow matches on, dropping any
...
// "en-US" (e.g. Nemotron Streaming) — against SuperFlow's canonical bare-code
...
// Country-flag emoji per language code, mapped explicitly so every icon is
// correct and renders reliably on macOS. Languages with no natural country
// flag map to undefined and render without a prefix.
const LANGUAGE_FLAGS: Record<string, string | undefined> = {
  en: "🇬🇧",
  zh: "🇨🇳",
  yue: "🇭🇰",
  de: "🇩🇪",
...
export const getLanguageFlag = (languageCode: string): string | undefined =>
