...
#[tauri::command]
#[specta::specta]
pub fn change_user_specification_setting(app: AppHandle, spec: String) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.user_specification = spec;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_audio_enhancement_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
...
#[tauri::command]
#[specta::specta]
pub fn change_tech_lexicon_enabled_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
...
#[tauri::command]
#[specta::specta]
pub fn change_show_live_streaming_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.show_live_streaming = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
