//! Model capability probing — the seam between SuperFlow's model UI and "what can
...
/// How confident we are that SuperFlow can run a given model, judged from its GGUF
