...
define_class!(
    ...
    #[name = "SuperFlowPasteProvider"]
    #[ivars = ProviderIvars]
    pub struct SuperFlowPasteProvider;

    impl SuperFlowPasteProvider {
...
struct MacPending {
    ...
    provider: Option<Retained<SuperFlowPasteProvider>>,
    auto_submit: bool,
...
pub(super) fn run(
    ...
    let provider = SuperFlowPasteProvider::new(state.clone(), text.to_string());
