; Custom NSIS template for SuperFlow with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\SuperFlow for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older SuperFlow releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "SuperFlow Portable Mode"
    FileClose $0
