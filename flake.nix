  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          superflow = pkgs.rustPlatform.buildRustPackage {
            pname = "superflow";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/cjpais/SuperFlow";
              license = lib.licenses.mit;
              mainProgram = "superflow";
              platforms = supportedSystems;
            };
          };

          default = self.packages.${system}.superflow;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.superflow.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.superflow;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.superflow.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.superflow;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "SuperFlow development environment"
              bun install
